window.onload = function() {
    ...
    function validateSurname() {
        if(!checkLength(surname.value, 3) ) {
            return false;
    ...
    function validatePhone() {
        if(!checkLength(phone.value, 10) ) {
            return false;
        }  else if(!checkLengthMax(phone.value, 10) ) {
            return false;
    ...
    function validateAddress() {
        if(!checkLength(address.value, 5) ) {
            ...
            return false;
        }  else if (!checkIfSpace(address.value)) {
            return false;
        } else {
            return true;
        }
    ...
    function validatePostalCode() {
        if(!checkLength(postalCode.value, 4) ) {
            return false;
        }  else if(!checkLengthMax(postalCode.value, 5) ) {
            return false;
